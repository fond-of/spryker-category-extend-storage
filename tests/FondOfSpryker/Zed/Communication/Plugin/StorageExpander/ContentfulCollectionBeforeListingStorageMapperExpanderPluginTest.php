...
class ContentfulCollectionBeforeListingStorageMapperExpanderPluginTest extends Unit
{
    /**
    ...
    /**
     * @var \FondOfSpryker\Zed\CategoryExtendStorage\Communication\Plugin\StorageExpander\ContentfulCollectionBeforeListingStorageMapperExpanderPlugin
     */
    protected $contentfulCollectionBeforeListingStorageMapperExpanderPlugin;
    ...
    protected function _before()
    {
        ...
        $this->categoryNodeStorageTransferMock = $this->getMockBuilder(CategoryNodeStorageTransfer::class)
            ...
            ->setMethods(['setContentfulCollectionBeforeListing'])
            ->getMock();
        ...
        $this->spyCategoryMock = $this->getMockBuilder(SpyCategory::class)
            ->disableOriginalConstructor()
            ->setMethods(['getContentfulCollectionBeforeListing'])
            ->getMock();
        ...
        $this->contentfulCollectionBeforeListingStorageMapperExpanderPlugin = new ContentfulCollectionBeforeListingStorageMapperExpanderPlugin();
    }
    ...
    public function testExpand(): void
    {
        ...
        $this->categoryNodeStorageTransferMock->expects($this->once())
            ->method('setContentfulCollectionBeforeListing')
            ->willReturnSelf();
        ...
        $this->spyCategoryMock->expects($this->once())
            ->method('getContentfulCollectionBeforeListing')
            ->willReturn('CONTENTFUL_ID');

        $this->contentfulCollectionBeforeListingStorageMapperExpanderPlugin->expand(
