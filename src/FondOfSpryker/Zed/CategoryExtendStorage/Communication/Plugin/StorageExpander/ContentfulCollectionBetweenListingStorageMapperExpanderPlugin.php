 ...
 */
class ContentfulCollectionBetweenListingStorageMapperExpanderPlugin extends AbstractPlugin implements StorageExpanderPluginInterface
{
    /**
    ...
    public function expand(
        ...
        $categoryNodeStorageTransfer->setContentfulCollectionBetweenListing($categoryNode->getCategory()->getContentfulCollectionBetweenListing());
    }
}
