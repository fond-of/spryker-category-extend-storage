 ...
 */
class ContentfulCollectionBeforeListingStorageMapperExpanderPlugin extends AbstractPlugin implements StorageExpanderPluginInterface
{
    /**
    ...
    public function expand(
        ...
        $categoryNodeStorageTransfer->setContentfulCollectionBeforeListing($categoryNode->getCategory()->getContentfulCollectionBeforeListing());
    }
}
