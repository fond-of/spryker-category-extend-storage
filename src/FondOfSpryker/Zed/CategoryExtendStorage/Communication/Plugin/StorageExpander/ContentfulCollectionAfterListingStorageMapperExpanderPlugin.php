 ...
 */
class ContentfulCollectionAfterListingStorageMapperExpanderPlugin extends AbstractPlugin implements StorageExpanderPluginInterface
{
    /**
    ...
    public function expand(
        ...
        $categoryNodeStorageTransfer->setContentfulCollectionAfterListing($categoryNode->getCategory()->getContentfulCollectionAfterListing());
    }
}
